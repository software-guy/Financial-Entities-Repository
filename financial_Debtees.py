...
Date Modified: 11-11-2017

"""
def function_AcquireOwedEntities():
    # Full list of debtees
    """list_of_Companys_Money_Is_Owed_To"""
    m = []
    ...
    file_name = input("What is the file name you want to save this information to: ")
    """ Opens and creates the filename below and writes the contents gathered until now """
    file_lod = open(file_name + ".txt", 'w') # file_lod = "handler" of copying file
